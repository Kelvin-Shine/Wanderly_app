...
final List<Destination> sampleDestinations = [
  const Destination(
    ...
    imageAsset: 'assets/images/kungliga_slottet.jpg',
    rating: 9.5,
    tags: ['City', 'Food', 'Asia'],
    visitors: 2428,
    price: 428.00,
  ...
  const Destination(
    ...
    name: 'Colosseum',
    location: 'Rome, Italy',
    imageAsset: 'assets/images/colosseum.jpg',
    rating: 9.2,
    tags: ['City', 'History'],
    visitors: 5210,
    price: 210.00,
  ...
  const Destination(
    ...
    imageAsset: 'assets/images/cyclades.jpg',
    rating: 9.0,
    tags: ['Islands', 'Beach'],
    visitors: 3120,
    price: 350.00,
  ...
  const Destination(
    ...
    imageAsset: 'assets/images/wawel_castle.jpg',
    rating: 8.9,
    tags: ['City', 'History'],
    visitors: 1875,
    price: 180.00,
  ...
  const Destination(
    ...
    imageAsset: 'assets/images/miroir_deau.jpg',
    rating: 9.1,
    tags: ['City', 'Landmark'],
    visitors: 2650,
    price: 260.00,
...
final List<Trip> sampleTrips = [
  const Trip(
    name: 'Vespa Tour',
    location: 'Rome, Italy',
    imageAsset: 'assets/images/vespa_tour.jpg',
  ),
  const Trip(
    name: 'Yoga retreat',
    location: 'Bali, Indonesia',
    imageAsset: 'assets/images/yoga_retreat.jpg',
  ),
  const Trip(
    name: 'Oktoberfest',
    location: 'Munich, Germany',
    imageAsset: 'assets/images/oktoberfest.jpg',
  ),
  const Trip(
    name: 'Brooklyn Bridge',
    location: 'New York City, USA',
    imageAsset: 'assets/images/brooklyn_bridge.jpg',
  ),
];
